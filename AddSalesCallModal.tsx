...
export default function AddSalesCallModal({ isOpen, onClose, onSave, onCreateAccount, accounts, theme, stages }: AddSalesCallModalProps) {
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
            <div className="w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border"
                ...
                <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto custom-scrollbar text-left">
                    ...
                    <div>
                        <label className="text-[10px] uppercase font-bold tracking-wider mb-1.5 block" style={{ color: colors.textMuted }}>Status</label>
